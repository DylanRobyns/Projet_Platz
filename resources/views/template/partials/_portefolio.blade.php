...
<div id="wrapper-container">
    ...
    <div id="wrapper-oldnew">
    	<div class="oldnew">
        	<div class="wrapper-oldnew-prev">
            	<div id="oldnew-prev" data-url="{{ route('more.resources') }}"></div>
        	</div>
        </div>
	</div>
    ...
    <div id="wrapper-copyright">
		<div class="copyright">
    		<div class="copy-text object">Copyright © 2021. Template by <a style="color:#D0D1D4;" href="https://dcrazed.com/">Dcrazed</a></div>
