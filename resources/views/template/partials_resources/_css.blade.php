...
#stripes{
	background: url({{ asset('assets/img/stripes.svg') }}) no-repeat;
	position:absolute;
	width:27px;
	height:20px;
	right:15px;
...
#fleche-nav-1,#fleche-nav-2,#fleche-nav-3{
	float:left;
	margin-top:26px;
	background: url({{ asset('assets/img/fleche-nav.svg') }}) no-repeat ;
	width:5px;
	height:10px;
	margin-left:5px;
}
...
#cross-menu{
	...
	right:25px;
	margin-top:25px;
	background: url({{ asset('assets/img/cross-menu.svg') }}) no-repeat;
	cursor:pointer;
}
...
.small-logo{
	...
	left:50%;
	margin-left:-65.5px;
	background: url({{ asset('assets/img/small-logo.svg') }}) no-repeat;
}
...
.image-reply-post{
	...
	width:65px;
	height:65px;
	background: url({{ asset('assets/img/avatar.svg') }}) no-repeat;
	top:0;
}

.image-reply-post{background: url({{ asset('assets/img/avatar.svg') }}) no-repeat;}
...
#tip_newsletter_input
{
    ...
    box-shadow: none;
	outline: 0;
	background: url({{ asset('assets/img/icon-newsletter.svg') }}) no-repeat 10px 9px;
	margin-left:20px;
...
#tip_search_input{
	...
	outline: 0;
	margin: 0;
	background: url({{ asset('assets/img/icon-search.svg') }}) no-repeat 12px 7px;
	vertical-align:center;
	margin-left:-40px;
	background-color:#FFF;
}
...
#loupe{
	position:absolute;
	background: url({{ asset('assets/img/loupe.svg') }}) no-repeat;
	width:28px;
	height:30px;
	right:20px;
	top:94px;
